...
#define JOYSTICK_EVENT_OCCURRED	0xFE	// will be used in keyboard queue to note that a joystick event happened. app can ignore or do something with that info.
